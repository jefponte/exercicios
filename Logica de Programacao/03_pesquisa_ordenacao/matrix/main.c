...
int main() {
    ...
    /*int numero = 0; //primo = 0, primo1 = 0;
    printf("Entre com o número para a verificação se é primo ou não: ");
    scanf("%d", &numero);
    if (verificaSeEhPrimo(numero)) {
        //primo =  retornaPrimoAnterior(numero);
        printf("O primeiro primo anterior é: %d\n", retornaPrimoAnterior(numero));
        printf("O segundo primo anterior é: %d\n", retornaPrimoAnterior(retornaPrimoAnterior(numero)));
        //primo1 = retornaPrimoPosterior(numero);
        printf("O primeiro primo posterior é: %d\n", retornaPrimoPosterior(numero));
        printf("O segundo primo posterior é: %d\n",retornaPrimoPosterior(retornaPrimoPosterior(numero)));
    } else {
